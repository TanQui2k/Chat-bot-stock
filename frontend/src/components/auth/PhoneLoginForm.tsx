    ...
    <div className="space-y-5">
      <div className="text-center">
        <h3 className="text-2xl font-bold bg-gradient-to-r from-violet-600 to-cyan-500 bg-clip-text text-transparent">
          {isRegister ? "Đăng ký bằng SĐT" : "Đăng nhập bằng SĐT"}
        </h3>
      ...
      {error && (
        <div className="p-3 bg-red-50 border border-red-200 rounded-xl text-red-600 text-sm animate-in fade-in slide-in-from-top-2 duration-300 text-center">
          {error}
        </div>
      )}
      ...
      <div className="space-y-5">
        ...
        <div className="text-center">
          <button
            ...
            className="text-sm text-violet-600 hover:text-violet-700 font-semibold hover:underline transition-all"
          >
        ...
        <div className="text-center pt-2">
          <button
            ...
            className="text-xs text-slate-400 hover:text-slate-600 transition-colors uppercase tracking-wider font-bold"
          >
