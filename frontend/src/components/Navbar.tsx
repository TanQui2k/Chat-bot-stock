      ...
      <header className="sticky top-0 z-50 w-full border-b border-border bg-background/80 backdrop-blur-md transition-colors duration-300">
        <div className="flex h-16 w-full items-center justify-between px-4 sm:px-6 lg:px-10">
          ...
          <div className="hidden lg:flex flex-col items-center justify-center animate-in fade-in slide-in-from-top-2 duration-700">
            ...
            <p className="text-[10px] text-muted-foreground font-bold tracking-widest uppercase opacity-80">
          ...
          <div className="flex items-center gap-4">
            <nav className="hidden md:flex gap-8 mr-6">
              ...
              <a href="#" className="text-sm font-medium text-muted-foreground hover:text-emerald-500 dark:hover:text-emerald-400 transition-all flex items-center gap-1.5 group">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4 text-muted-foreground group-hover:text-emerald-500 dark:group-hover:text-emerald-400 transition-colors">
            ...
            {user ? (
              ...
              <button 
                ...
                className="flex items-center gap-2 rounded-full border border-border bg-muted/50 pl-3 pr-1 py-1 text-sm font-medium transition-all hover:bg-muted hover:border-border/80 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 group"
              >
                <span className="text-foreground group-hover:text-emerald-500 dark:group-hover:text-emerald-400 transition-colors">Đăng nhập</span>
                <div className="h-7 w-7 rounded-full bg-border flex items-center justify-center text-xs text-muted-foreground font-bold shadow-sm group-hover:bg-emerald-500 group-hover:text-white transition-all">
                  VA
                </div>
              </button>
            )}
